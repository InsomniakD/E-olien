...
void tension(void)
	{
		...
		debug_printf("La tension est : %d.%02d\n", valeur/10000,(valeur%1000)/10);//On affiche la valeur en V, en affichant le nombre, en mettant une virgule après 2 chiffres(conversion en V), et on affiche les valeurs après .
	}
